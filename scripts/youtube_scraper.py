...
class YoutubeScraper:
    ...
    def _add_video_to_db(
        ...
        video_db_id = self.video_db_connector.add_video(youtube_video_id, video_title)
        for sentence in sentences_in_video:
            self.video_db_connector.add_video_sentences_crossref(
    ...
    def _add_new_words_and_sentences_to_db(self, sentences: list[JapaneseSentence]):
        ...
        for sentence in sentences:
            ...
            added_sentence = sentence_db_connector.add_sentence_if_new(sentence)
            if added_sentence:
        ...
        for sentence in added_sentences:
            for word in sentence.words:
                sentence_db_connector.add_sentence_word_crossref(
